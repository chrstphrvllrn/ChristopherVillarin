...
function startAnimation() {
	...
	//FRAME1
	tween.to("#frame1Image-wrapper", {opacity:0.99,duration: 1,ease: "power2.out"},"+=0");
	tween.to("#frame1Headline-wrapper",{opacity:1},"+=0")
	tween.from(lines, { duration: 0.4, opacity: 0, y: 40, stagger: 0.09 },"-=0.6");
	tween.to("#frame1Subheadline-wrapper",{opacity:1},"-=0.4")
	tween.from(sublines, { duration: 0.4, opacity: 0, y: 40, stagger: 0.09 },"-=0.4");
	...
	//FRAME2
	tween.to("#frame2Image-wrapper", {opacity:0.99,duration: 1,ease: "power2.out"},"+=0");
	tween.to("#frame2Headline-wrapper",{opacity:1},"+=0")
	tween.from(lines2, { duration: 0.4, opacity: 0, y: 40, stagger: 0.09 },"-=0.4");
	tween.to("#frame2Subheadline-wrapper",{opacity:1},"-=0.4")
	tween.from(sublines2, { duration: 0.4, opacity: 0, y: 40, stagger: 0.09 },"-=0.4");
	...
	//FRAME3
	tween.to("#frame3Image-wrapper", {opacity:0.99,duration: 1,ease: "power2.out"},"+=0");
	tween.to("#frame3Headline-wrapper",{opacity:1},"+=0")
	tween.from(lines3, { duration: 0.4, opacity: 0, y: 40, stagger: 0.09 },"-=0.4");
	tween.to("#frame3Subheadline-wrapper",{opacity:1},"-=0.4")
	tween.from(sublines3, { duration: 0.4, opacity: 0, y: 40, stagger: 0.09 },"-=0.4");
	//CTA
