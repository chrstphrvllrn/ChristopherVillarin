            ...
            <section className="w-full flex flex-col md:flex-row text-[#1B224A] font-light mx-auto sm:max-w-[640px] md:max-w-[768px] lg:max-w-[924px] xl:max-w-[1240px] ">
                ...
                <div className="w-1/2  min-h-[30vh] flex flex-col md:flex-col text-[#1B224A] font-light mx-auto sm:max-w-[640px] md:max-w-[768px] lg:max-w-[924px] xl:max-w-[1240px] p-5 m-5 gap-5 ">
                    ...
                    <div className="w-full  flex flex-row text-center text-xs justify-end mx-auto sm:max-w-[640px] md:max-w-[768px] lg:max-w-[924px] xl:max-w-[1240px] bg-gray-0  p-5 m-5 gap-5">
                        <div className="w-[260px] h-[200px] flex flex-col justify-between items-center bg-gray-0 hover:bg-gray-200 cursor-pointer"> <img src={certificate} alt='cert1' className='border p-7 rounded-lg' /> <h2 className='text-md font-bold'>Tailwind CSS From Scratch | Learn By Building Projects</h2> </div>
                        <div className="w-[260px] h-[200px] flex flex-col justify-between items-center bg-gray-0 hover:bg-gray-200 cursor-pointer"> <img src={certificate} alt='cert2' className='border p-7 rounded-lg' /> <h2 className='text-md font-bold'>MERN 2024 Edition - MongoDB, Express, React and NodeJS</h2></div>
                        <div className="w-[260px] h-[200px] flex flex-col justify-between items-center bg-gray-0 hover:bg-gray-200 cursor-pointer"> <img src={certificate} alt='cert2' className='border p-7 rounded-lg' /> <h2 className='text-md font-bold'>React, NodeJS, Express & MongoDB - The MERN Fullstack Guide</h2></div>
                    </div>
                </div>
