                    ...
                    <div className="
                        ...
                        <div className="
                            ...
                            CHRISTOPHER<br />VILLARIN
                                ...
                                className='text-sm bg-button-dark hover:bg-button-light text-[#fff] hover:text-[#2E2F2F] w-[160px] rounded-full font-medium  py-3 px-1 mr-3 transition-all duration-150 ease-in-out' style={{ transition: 'background-color 0.3s' }}>Check my Portfolio</button>
