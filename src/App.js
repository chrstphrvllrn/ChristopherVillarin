  ...
  return (
    <div className=''>
      ...
      <section className='flex flex-col sm:flex-col md:flex-row'>
            <div className="w-full sm:w-full md:w-1/2 px-8 sm:px-8 md:px-16 flex flex-col md:flex-row text-[#030303] font-light" >
                  ...
                  {/* <p className='text-4xl p-4 font-light w-full leading-snug text-[#1B224A] '>Hey there, I'm<br />  <p className='text-6xl md:text-8xl lg:text-9xl xl:text-9xl font-medium bebas-neue-regular text-[#1B224A] bg-gradient-to-b from-[#4164A1] via-[#7A4A8A] to-[#7A4A8A] bg-clip-text text-transparent '>CHRISTOPHER<br />VILLARIN</p></p> */}
                    ...
                    <p className='text-sm px-8 sm:px-8 md:px-4 text-[#626c81] w-full font-regular '>a Front End Developer / Creative Developer</p>
            ...
            <div className="w-full sm:w-full md:w-1/2 px-8 sm:px-8 md:px-16 min-h-[70vh] flex flex-row justify-center items-center md:flex-row text-[#030303] font-light bg-[url('./images/background/iphone.png')] bg-cover bg-center bg-no-repeat xl:bg-contain lg:bg-contain " >
            </div>
      </section>
    </div>);
}
