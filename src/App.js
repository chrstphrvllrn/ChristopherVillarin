    ...
    <div>
      ...
      <div className="w-full flex flex-col md:flex-row text-[#030303] font-light bg-slate-50 ">
        <div className="w-full min-h-[70vh] flex flex-col text-left justify-center mx-auto sm:max-w-[640px] md:max-w-[768px] lg:max-w-[924px] xl:max-w-[1240px]"> {/**/}
          <p className='text-4xl p-4 font-light w-full leading-snug text-[#1B224A] '>Hey there, I'm<br />  <p className='text-6xl md:text-8xl lg:text-9xl xl:text-9xl font-medium bebas-neue-regular text-[#1B224A] '>CHRISTOPHER<br />VILLARIN</p></p>
          ...
          <div className='w-full flex flex-row'>
            <button className='bg-[#9DD4AC] hover:bg-[#f3f3f3] text-[#000] hover:text-[#000] w-[180px] rounded-full font-medium  py-3 px-1 mr-3 ' style={{ transition: 'background-color 0.3s' }}>About me</button>
            <button className='bg-[#f3f3f3] hover:bg-[#1B224A] text-[#1B224A] hover:text-[#fff] w-[180px] rounded-full font-medium  py-3 px-1   ' style={{ transition: 'background-color 0.3s' }}>Contact</button>
