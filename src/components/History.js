            ...
            <div className="w-full flex flex-col md:flex-row text-[#1B224A] font-light mx-auto sm:max-w-[640px] md:max-w-[768px] lg:max-w-[924px] xl:max-w-[1240px] ">
                ...
                <div className="w-1/2  min-h-[30vh] flex flex-col md:flex-col text-[#1B224A] font-light mx-auto sm:max-w-[640px] md:max-w-[768px] lg:max-w-[924px] xl:max-w-[1240px] p-5 m-5 gap-5 ">
                    ...
                    <div className="w-full flex flex-row text-left justify-center mx-auto sm:max-w-[640px] md:max-w-[768px] lg:max-w-[924px] xl:max-w-[1240px] bg-gray-0  p-5 m-5 gap-5 text-white">
                        <div className="w-[260px] h-[150px]  flex flex-col justify-end items-center  text-[#1B224A] hover:bg-gray-100 cursor-pointer">    <img src={hogarth} className='border rounded-lg shadow-md' /> <h2 className='text-md font-bold'>Hogarth</h2><h3 className='text-xs'>2023 - present</h3> </div>
                        <div className="w-[260px] h-[150px] flex flex-col justify-end items-center text-[#1B224A] hover:bg-gray-100 cursor-pointer"> <img src={smartly} className='border rounded-lg shadow-md' /> <h2 className='text-md font-bold'>Smartly</h2><h3 className='text-xs'>2018 - 2023</h3></div>
                        <div className="w-[260px] h-[150px] flex flex-col justify-end items-center  text-[#1B224A] hover:bg-gray-100 cursor-pointer"> <img src={sizmek} className='border rounded-lg shadow-md' /> <h2 className='text-md font-bold'>Sizmek</h2><h3 className='text-xs'>2015 - 2017</h3></div>
                        <div className="w-[260px] h-[150px] flex flex-col justify-end items-center  text-[#1B224A] hover:bg-gray-100 cursor-pointer"> <img src={wideout} className='border rounded-lg shadow-md' /> <h2 className='text-md font-bold'>WideOut</h2><h3 className='text-xs'>2014 - 2015</h3></div>
                    </div>
