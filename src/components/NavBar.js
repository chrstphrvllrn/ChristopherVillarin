                ...
                <div className='w-full flex flex-row justify-between items-center'>
                    ...
                    <div className='flex flex-row justify-end gap-10'>
                        ...
                        hidden sm:flex md:flex lg:flex xl:flex'>
                            <Link to="/" className='hover:bg-[#fac541] hover:text-[#000] rounded-l-full bg-[#f3f3f3]' style={{ transition: 'background-color 0.5s' }}> <li className='p-4 mx-5  cursor-pointer' >HOME</li></Link>
                            {/* <p className='p-4 font-light text-gray-400'>|</p> */}
                            <Link to="/portfolio" className='hover:bg-[#fac541] hover:text-[#000] bg-[#f3f3f3]' style={{ transition: 'background-color 0.5s' }}> <li className='p-4 mx-5 cursor-pointer' >PORTFOLIO</li></Link>
                            {/* <p className='p-4 font-light text-gray-400'>|</p> */}
                            <Link to="/history" className='hover:bg-[#fac541] hover:text-[#000] bg-[#f3f3f3]' style={{ transition: 'background-color 0.5s' }}><li className='p-4 mx-5 cursor-pointer' >HISTORY</li></Link>
                            {/* <p className='p-4 font-light text-gray-400'>|</p> */}
                            <Link to="/skills" className='hover:bg-[#fac541] hover:text-[#000] rounded-r-full bg-[#f3f3f3]' style={{ transition: 'background-color 0.5s' }}> <li className='p-4 mx-5 cursor-pointer'  >SKILLS</li></Link>
