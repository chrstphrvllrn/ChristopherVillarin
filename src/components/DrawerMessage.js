                    ...
                    <div className="mx-auto w-12 h-1.5 flex-shrink-0 rounded-full bg-zinc-300 mb-8" />
                         ...
                         {/* <div class="mt-2">
                            ...
                            <div class="col-span-full">
                                ...
                                <div class="mt-2">
                                <textarea id="messagebox" name="messagebox" rows="6" cols="30" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 px-[0.5rem]" ></textarea>
                                </div>
                            </div>
